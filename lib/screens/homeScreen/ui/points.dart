...
import 'package:scrap_it/homeScreen/DatabaseConnectors/User.dart';
...
Widget pointPage(BuildContext context) {
  ...
  return FutureBuilder(
    future: User().getUserPoints('kanubestnipundud@gmail.com'),
    ...
    child: Text(snapshot.data['points'].toString() +" /1000",
